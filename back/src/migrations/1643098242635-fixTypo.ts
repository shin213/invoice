...
export class fixTypo1643098242635 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "requests" DROP CONSTRAINT "FK_845adcd2065e4b2b8c726299cf8"`);
        await queryRunner.query(`CREATE TYPE "public"."invoices_status_enum" AS ENUM('not_requested', 'requested', 'completely_approved')`);
        await queryRunner.query(`CREATE TABLE "invoices" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "status" "public"."invoices_status_enum" NOT NULL, "company_id" integer, CONSTRAINT "PK_668cef7c22a427fd822cc1be3ce" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "requests" ADD CONSTRAINT "FK_845adcd2065e4b2b8c726299cf8" FOREIGN KEY ("comment_id") REFERENCES "comments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "requests" ADD CONSTRAINT "FK_845adcd2065e4b2b8c726299cf8" FOREIGN KEY ("comment_id") REFERENCES "commets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "requests" ADD CONSTRAINT "FK_185e1184286ce9ddfb6e62db1d3" FOREIGN KEY ("invoice_id") REFERENCES "inovices"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "judgements" ADD CONSTRAINT "FK_2db810dcb5c201e3aea9ed762dd" FOREIGN KEY ("comment_id") REFERENCES "commets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
