...
export class userAddColumns1643190906800 implements MigrationInterface {
  name = 'userAddColumns1643190906800'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "employee_code" character varying NOT NULL`,
    )
  }
