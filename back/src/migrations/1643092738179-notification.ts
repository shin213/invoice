...
export class notification1643092738179 implements MigrationInterface {
  name = 'notification1643092738179'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."request_notifications_is_read_enum" AS ENUM('read', 'unread')`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."inovices_status_enum" AS ENUM('not_requested', 'requested', 'completely_approved')`,
    )
    await queryRunner.query(
      `CREATE TABLE "inovices" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "status" "public"."inovices_status_enum" NOT NULL, "company_id" integer, CONSTRAINT "PK_9bff7cf5c080d7695fc7f4f35cc" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "commets" ("id" SERIAL NOT NULL, "content" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "invoice_id" integer, "user_id" integer, "request_id" integer, CONSTRAINT "PK_714e667b12c872132ba64661a9b" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "request_notifications" ADD CONSTRAINT "FK_def337c7088424cc4d98352b73d" FOREIGN KEY ("request_receiver_id") REFERENCES "request_receiver"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "request_receiver" ADD CONSTRAINT "FK_7433191d9676a2ab307970fa13e" FOREIGN KEY ("request_id") REFERENCES "requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "judgements" ADD CONSTRAINT "FK_bc6b0e4993ea6755325256f5d6c" FOREIGN KEY ("request_id") REFERENCES "requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "inovices" ADD CONSTRAINT "FK_22bb5c62e30faa8f9ecc3065858" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "commets" ADD CONSTRAINT "FK_d5cf8cba01527b87350bbf281b4" FOREIGN KEY ("invoice_id") REFERENCES "inovices"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "commets" ADD CONSTRAINT "FK_e070ff9f48ad257d6a7383de2ea" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "commets" ADD CONSTRAINT "FK_01283b110ea53ea296998e84f1c" FOREIGN KEY ("request_id") REFERENCES "requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "commets" DROP CONSTRAINT "FK_01283b110ea53ea296998e84f1c"`,
    )
    await queryRunner.query(
      `ALTER TABLE "commets" DROP CONSTRAINT "FK_e070ff9f48ad257d6a7383de2ea"`,
    )
    await queryRunner.query(
      `ALTER TABLE "commets" DROP CONSTRAINT "FK_d5cf8cba01527b87350bbf281b4"`,
    )
    await queryRunner.query(
      `ALTER TABLE "inovices" DROP CONSTRAINT "FK_22bb5c62e30faa8f9ecc3065858"`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "judgements" DROP CONSTRAINT "FK_bc6b0e4993ea6755325256f5d6c"`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "request_receiver" DROP CONSTRAINT "FK_7433191d9676a2ab307970fa13e"`,
    )
    await queryRunner.query(
      `ALTER TABLE "request_notifications" DROP CONSTRAINT "FK_def337c7088424cc4d98352b73d"`,
    )
    await queryRunner.query(
      `ALTER TABLE "request_notifications" DROP CONSTRAINT "FK_bc6992e40cf6d96edf6e3edaddd"`,
    )
    await queryRunner.query(`DROP TABLE "commets"`)
    await queryRunner.query(`DROP TABLE "inovices"`)
    await queryRunner.query(`DROP TYPE "public"."inovices_status_enum"`)
    ...
    await queryRunner.query(
      `DROP TYPE "public"."request_notifications_type_enum"`,
    )
    await queryRunner.query(
      `DROP TYPE "public"."request_notifications_is_read_enum"`,
    )
  }
}
