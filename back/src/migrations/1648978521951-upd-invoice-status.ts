...
export class updInvoiceStatus1648978521951 implements MigrationInterface {
  name = 'updInvoiceStatus1648978521951'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."invoices_status_enum" AS ENUM('inputting_with_system', 'inputting_file', 'awaiting_receipt', 'under_approval', 'declined', 'completely_approved')`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."invoices_status_enum_old" AS ENUM('not_requested', 'requested', 'rejected', 'completely_approved')`,
    )
    await queryRunner.query(
