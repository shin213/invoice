...
export class fmtElemValueType1646384154829 implements MigrationInterface {
  name = 'fmtElemValueType1646384154829'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "invoice_format_elements" ADD "value_type" "public"."invoice_format_elements_value_type_enum" NOT NULL`,
    )
    await queryRunner.query(
