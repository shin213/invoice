...
export class updInvoiceStatus1648964441836 implements MigrationInterface {
  name = 'updInvoiceStatus1648964441836'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."invoices_status_enum" AS ENUM('inputting_with_system', 'inputting_file', 'awaiting_receipt', 'under_approval', 'completely_approved')`,
    )
    await queryRunner.query(
